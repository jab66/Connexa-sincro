...
class BarcodeFunc:
    ...
    def insert_barcode_from_csv(self, df):
        ...
        Return: None
        """   
        archivo = f'{self.folder}insert_barcode.csv'
        df.to_csv(archivo, 
    ...
    def imprimir_dataframe(self, dataframe, nombre_archivo):
        """
        Genera un archivo csv con la informacion enviada en el dataframe.
        """
        dataframe.to_csv(f'{self.folder}{nombre_archivo}.csv', index=False)
